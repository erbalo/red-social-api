...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = usuario.Preparar(tipos.REGISTRO); erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = usuario.Preparar(tipos.EDICION); erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
// PararDeSeguirUsuario permite que um usuario pare seguir outro
