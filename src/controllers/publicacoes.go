...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Nao e possivel atualizar uma publicacao nao seja sua"))
		return
	}
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Nao e possivel deletar uma publicacao nao seja sua"))
		return
	}
...
// BuscarPublicacoesPorUsuario traz todas as publicacoes de um usuario especfico
